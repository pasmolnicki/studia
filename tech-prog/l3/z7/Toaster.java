...
public class Toaster extends AbstractAppliance {
	...
	public void turnOn() throws ApplianceCommunicationException {
		...
		if (this.applianceStateBehavior.getState() != ApplianceState.ON) {
			throw new ApplianceCommunicationException();
		}
	}
	...
	public void turnOff() throws ApplianceCommunicationException {
		...
		if (this.applianceStateBehavior.getState() != ApplianceState.OFF) {
			throw new ApplianceCommunicationException();
		}
	}
	...
	public void start() throws ApplianceCommunicationException {
		...
		if (this.applianceStateBehavior.getState() != ApplianceState.STARTED) {
			throw new ApplianceCommunicationException();
		}
	}
	...
	public void stop() throws ApplianceCommunicationException {
		...
		if (this.applianceStateBehavior.getState() != ApplianceState.STOPPED) {
			throw new ApplianceCommunicationException();
		}
	}
}
