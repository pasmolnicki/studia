...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Analyze SA parameter tuning results and generate plots."
    )
    parser.add_argument(
        "csv_path",
        nargs="?",
        default="results/sa_parameter_tuning.csv",
        help="Path to the CSV file (default: results/sa_parameter_tuning.csv)",
    )
    parser.add_argument(
        "--top",
        type=int,
...
def plot_3d_pairs(
    ...
    pairs = [
        ...
        ("initial_temperature", "epoch_length"),
        ("initial_temperature", "no_improve_limit"),
        ("cooling_factor", "epoch_length"),
        ("cooling_factor", "no_improve_limit"),
        ("epoch_length", "no_improve_limit"),
    ]
